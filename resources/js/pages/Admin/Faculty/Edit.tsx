...
export default function EditFaculty({ faculty, departments }: Props) {
    const form = useForm({
        faculty_code: faculty.faculty_code,
        full_name: faculty.full_name,
        middle_name: faculty.middle_name ?? '',
        call_name: faculty.call_name ?? '',
        contact_no: faculty.contact_no ?? '',
        email: faculty.email ?? '',
        emp_type: faculty.emp_type ?? '',
    ...
    const onSubmit: FormEventHandler = (e) => {
        e.preventDefault();
        form.put(adminRoutes.faculty.update({ faculty: faculty.id }).url);
    };
            ...
            <div className="flex flex-1 flex-col gap-4 p-4">
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Update faculty fields based on the XLSX headers.
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
