...
export default function FacultyLoadShow({ term, load, isLocked }: Props) {
    const termLoadsHref = `/admin/terms/${term.id}/faculty-loads`;
    ...
    const updateItemStatus = (
        ...
        router.patch(
            `/admin/terms/${term.id}/faculty-loads/${load.id}/items/${item.id}/status`,
            {
                status,
                remarks,
            },
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        {
            title: `Load #${load.id}`,
            href: `/admin/terms/${term.id}/faculty-loads/${load.id}`,
        },
    ];
