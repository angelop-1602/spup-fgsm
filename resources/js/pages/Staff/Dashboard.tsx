...
export default function StaffDashboard({
    ...
    return (
        <StaffLayout breadcrumbs={breadcrumbs}>
            <Head title="Registrar Staff Dashboard" />
            <div className="flex flex-1 flex-col gap-4 p-4">
                <Card>
                    <CardHeader>
                        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                            <div>
                                <CardTitle>Registrar Staff Analytics</CardTitle>
                                <CardDescription>
                                    Department completion and employment
                                    breakdown for monitoring submissions.
                                </CardDescription>
                            </div>
                ...
                {terms.length > 0 && summary.totalLoads === 0 && (
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Departments are still shown so you can validate
                                where submissions are still zero.
                            </CardDescription>
                        </CardHeader>
                    </Card>
                )}
